...
class Solution {
    public int[] validSequence(String word1, String word2) {
        ...
        // ---------------------------------------
        // Step 1: Build last[] from RIGHT to LEFT
        // ---------------------------------------
        ...
        // ---------------------------------------
        // Step 2: Greedily build answer LEFT to RIGHT
        // ---------------------------------------

        boolean canSkip = true; // We have not used our 1 mismatch yet
        ...
        // If we successfully selected m indices
        if (j == m) {
            return ans;
        }
